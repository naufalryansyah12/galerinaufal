...
<head>
    ...
    <link rel="icon" type="image/jpeg" href="logolink.jpeg"> <!-- Corrected image type -->
...
<div id="wrapper">
    <div id="header">
        ...
        <form action="update_foto.php" method="post" enctype="multipart/form-data"> <!-- Added enctype for file upload -->
            <?php
                include "koneksi.php";
                $fotoid = $_GET['fotoid']; // Be cautious, validate user input
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select name="albumid">
                        <?php
                            $userid = $_SESSION['userid']; // Sanitize this value before using in SQL query

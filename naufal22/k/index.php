...
<head>
    ...
    <title>Halaman galery naufal gtg</title>
...
<body>
    <h1>Website Galeri Foto Naufal</h1>
    ...
    ?>   
        <p>Selamat datang Ganteng <b><?=$_SESSION['namalengkap']?></b></p>
        <ul>
            ...
            <div class="category-container">
                ...
                ?>
                    <div class="category-item" style="margin-top: 20px; margin-bottom: 20px;">
                        ...
                        <img src="bg1.jpg" alt="<?php echo $data['namaalbum'] ?>" class="category-icon">

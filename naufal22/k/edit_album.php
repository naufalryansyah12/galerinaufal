...
<head>
    ...
    <body style="background-image: url('bg2.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
<div id="wrapper">
    <style>
        * {
    margin: 0;
...
<div id="wrapper">
    <div id="header">
    <h1 style="color: #336633">Website Galeri Foto Naufal </h1>
    <p>Perbarui albummu sendiri ye suka suka</p>
